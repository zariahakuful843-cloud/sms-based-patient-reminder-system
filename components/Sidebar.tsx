    ...
    <aside className="w-64 bg-slate-900 text-white flex flex-col h-screen sticky top-0 shrink-0">
      ...
      <div className="px-6 py-5 border-b border-slate-700/60">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-semibold text-sm leading-tight text-white">CareRemind</p>
            <p className="text-xs text-slate-400">Patient Reminder System</p>
          </div>
        </div>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 overflow-y-auto">
        ...
        <div className="mt-6 pt-4 border-t border-slate-700/60">
          <p className="px-3 mb-2 text-xs font-semibold text-slate-500 uppercase tracking-wider">Documentation</p>
          <ul className="space-y-0.5">
            <li>
              <a
                href="/docs/PRD.md"
      ...
      <div className="px-4 py-4 border-t border-slate-700/60">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm font-medium text-white truncate">Maria R.</p>
            <p className="text-xs text-slate-400 truncate">Clinic Receptionist</p>
          </div>
          <button className="ml-auto text-slate-500 hover:text-slate-300 transition-colors" title="Sign out">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
